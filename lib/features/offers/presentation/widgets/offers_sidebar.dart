...
/// Sidebar pour l'écran des offres tablette.
///
/// Contient:
...
/// - Navigation
/// - Actions rapides
class OffersSidebar extends StatelessWidget {
  /// Manager des offres
    ...
    return BlocBuilder<OfferCubit, OfferState>(
      builder: (context, state) {
        if (state is OffersLoaded) {
          return _buildStats(context, state.offers);
        }
  ...
  Widget _buildStats(BuildContext context, List<Offer> offers) {
    final l10n = AppLocalizations.of(context);
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildStatRow(l10n.totaloffre, '${offers.length}'),
          const SizedBox(height: 8),
          _buildStatRow(l10n.activee, '$activeOffersCount'),
        ],
      ),
    );
  }
