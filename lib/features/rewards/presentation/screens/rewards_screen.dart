...
import 'package:mukhlissmagasin/features/rewards/presentation/widgets/widgets.dart';
...
class _RewardsScreenState extends State<RewardsScreen>
  ...
  ///
  /// Utilise le widget refactorisé [RewardsSidebar].
          ...
          Expanded(
            child: Align(
              ...
              child: ConstrainedBox(
                constraints:
                    BoxConstraints(maxWidth: 300), // Largeur réduite à 80
                child: Container(
                  ...
                  child: TextField(
                    ...
                    style:
                        TextStyle(fontSize: 12), // Texte de saisie plus petit
  ...
  ///
  /// Utilise le widget refactorisé [RewardsLoadingState].
  Widget _buildLoadingState(BuildContext context) {
    return RewardsLoadingState(fadeAnimation: _fadeAnimation);
  }

  /// Construit l'état d'erreur.
  ///
  /// Utilise le widget refactorisé [RewardsErrorState].
  Widget _buildErrorState(String message) {
    return RewardsErrorState(message: message);
  }

  /// Construit l'état vide.
  ///
  /// Utilise le widget refactorisé [RewardsEmptyState].
  ...
  Widget _buildRewardsGrid(
      RewardsLoaded state, RewardManager manager, BuildContext context) {
    ...
    List<dynamic> filteredRewards = state.rewards.where((reward) {
      ...
      if (_searchQuery.isNotEmpty) {
        final nameMatch =
            reward.name.toLowerCase().contains(_searchQuery.toLowerCase());
                      ...
                      child: Opacity(
                        ...
                        child: Container(
                          ...
                          child: RewardCard(
                            ...
                            onDelete: () =>
                                _showDeleteDialog(context, manager, reward.id),
                            onEdit: () =>
                                manager.navigateToEditReward(context, reward),
                          ),
                        ),
                      ),
                    );
  ...
  Widget _buildRewardsList(
      RewardsLoaded state, BuildContext context, RewardManager manager) {
    List<dynamic> filteredRewards = state.rewards.where((reward) {
      // Filtre par statut (nouveau)
      bool statusMatch = true;
      if (_selectedFilter == 'active') {
                          ...
                          child: ClipRRect(
                            ...
                            child: SizedBox(
                              ...
                              child: RewardCard(
                                ...
                                onTap: () => manager
                                    .showRewardDetail(filteredRewards[index]),
                                onDelete: () => _showDeleteDialog(context,
                                    manager, filteredRewards[index].id),
                                onEdit: () => manager.navigateToEditReward(
                                    context, filteredRewards[index]),
                              ),
                            ),
                          ),
                        ),
  ...
  void _showDeleteDialog(
      BuildContext context, RewardManager manager, String id) {
    final l10n = AppLocalizations.of(context);
    showDialog(
      context: context,
