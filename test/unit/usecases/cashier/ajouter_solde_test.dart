...
void main() {
  ...
  group('Ajouter Solde UseCase - Validation', () {
    ...
    test('montant négatif throw exception', () async {
      ...
      // ACT & ASSERT - Le use case valide le montant avant d'appeler le repo
      expect(
      ...
      // Le repository ne devrait pas être appelé
      verifyNever(mockRepository.ajouterSoldeEtAppliquerOffres(
        clientId: anyNamed('clientId'),
        magasinId: anyNamed('magasinId'),
        montant: anyNamed('montant'),
      ));
