...
void main() {
  ...
  group('Réclamer Récompense', () {
    ...
    blocTest<CaissierCubit, CaissierState>(
      ...
      expect: () => [
        isA<CaissierError>()
            .having((s) => s.message, 'message', contains('Points insuffisants')),
      ],
    );
  });
  ...
  group('Get Current Magasin', () {
    final magasin = MagasinModel(
      ...
      geom: {'type': 'Point', 'coordinates': [-7.5, 33.5]},
      categorieId: 1,
      imageUrl: '',
    ...
    blocTest<CaissierCubit, CaissierState>(
      ...
      expect: () => [
        ...
        isA<CurrentMagasinLoaded>()
            ...
            .having((s) => s.magasin.nomEnseigne, 'nomEnseigne', equals('Boutique Test')),
      ],
    );
  ...
  group('Get Client By Code', () {
    ...
    test('getClientByUniqueCode code invalide throw exception', () async {
      // ARRANGE
      when(mockGetclientByuniquecode.execute(uniqueCode: anyNamed('uniqueCode')))
          .thenThrow(Exception('Client non trouvé'));
